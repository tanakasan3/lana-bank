...
use crate::{
    ...
    primitives::{
        ...
        CREDIT_COLLATERAL,
        // Account Set Specs
        CREDIT_COLLATERAL_OMNIBUS,
        CREDIT_DISBURSED_DEFAULTED,
        CREDIT_FACILITY_COLLATERAL_IN_LIQUIDATION,
        CREDIT_FACILITY_ENTITY_TYPE,
        CREDIT_FACILITY_LIQUIDATED_COLLATERAL,
        CREDIT_FACILITY_LIQUIDATION_PROCEEDS_OMNIBUS,
        CREDIT_FACILITY_OMNIBUS,
        CREDIT_FACILITY_PROCEEDS_FROM_LIQUIDATION,
        CREDIT_FACILITY_PROPOSAL_ENTITY_TYPE,
        CREDIT_FACILITY_REMAINING,
        CREDIT_FEE_INCOME,
        CREDIT_INTEREST_ADDED_TO_OBLIGATIONS_OMNIBUS,
        CREDIT_INTEREST_DEFAULTED,
        CREDIT_INTEREST_INCOME,
        CREDIT_PAYMENT_HOLDING,
        CREDIT_PAYMENTS_MADE_OMNIBUS,
        CREDIT_UNCOVERED_OUTSTANDING,
        CalaAccountId,
        CalaAccountSetId,
        CollateralId,
        CreditFacilityId,
        CustomerType,
        DisbursalId,
        DisbursedReceivableAccountCategory,
        DisbursedReceivableAccountType,
        FacilityDurationType,
        InterestReceivableAccountType,
        LONG_TERM_BANK_DISBURSED_RECEIVABLE,
        LONG_TERM_BANK_INTEREST_RECEIVABLE,
        ...
        LedgerTxId,
        OVERDUE_BANK_DISBURSED_RECEIVABLE,
        ...
        SHORT_TERM_BANK_INTEREST_RECEIVABLE,
...
impl CreditLedger {
    ...
    pub async fn init(
        ...
        let collateral_omnibus_account_ids = Self::find_or_create_omnibus_account(
            cala,
            journal_id,
            format!("{journal_id}:{}", CREDIT_COLLATERAL_OMNIBUS.account_set_ref),
            format!("{journal_id}:{}", CREDIT_COLLATERAL_OMNIBUS.account_ref),
            CREDIT_COLLATERAL_OMNIBUS.name.to_string(),
        ...
        let interest_added_to_obligations_omnibus_account_ids =
            Self::find_or_create_omnibus_account(
                ...
                format!(
                    "{journal_id}:{}",
                    CREDIT_INTEREST_ADDED_TO_OBLIGATIONS_OMNIBUS.account_set_ref
                ),
                format!(
                    "{journal_id}:{}",
                    CREDIT_INTEREST_ADDED_TO_OBLIGATIONS_OMNIBUS.account_ref
                ),
                CREDIT_INTEREST_ADDED_TO_OBLIGATIONS_OMNIBUS
                    .name
                    .to_string(),
        ...
        let payments_made_omnibus_account_ids = Self::find_or_create_omnibus_account(
            ...
            format!(
                "{journal_id}:{}",
                CREDIT_PAYMENTS_MADE_OMNIBUS.account_set_ref
            ),
            format!("{journal_id}:{}", CREDIT_PAYMENTS_MADE_OMNIBUS.account_ref),
            CREDIT_PAYMENTS_MADE_OMNIBUS.name.to_string(),
        ...
        let facility_omnibus_account_ids = Self::find_or_create_omnibus_account(
            cala,
            journal_id,
            format!("{journal_id}:{}", CREDIT_FACILITY_OMNIBUS.account_set_ref),
            format!("{journal_id}:{}", CREDIT_FACILITY_OMNIBUS.account_ref),
            CREDIT_FACILITY_OMNIBUS.name.to_string(),
        ...
        let liquidation_proceeds_omnibus_account_ids = Self::find_or_create_omnibus_account(
            ...
            format!(
                "{journal_id}:{}",
                CREDIT_FACILITY_LIQUIDATION_PROCEEDS_OMNIBUS.account_set_ref
            ),
            format!(
                "{journal_id}:{}",
                CREDIT_FACILITY_LIQUIDATION_PROCEEDS_OMNIBUS.account_ref
            ),
            CREDIT_FACILITY_LIQUIDATION_PROCEEDS_OMNIBUS
                .name
                .to_string(),
        ...
        let facility_account_set_id = Self::find_or_create_account_set(
            cala,
            journal_id,
            format!("{journal_id}:{}", CREDIT_FACILITY_REMAINING.external_ref),
            CREDIT_FACILITY_REMAINING.name.to_string(),
        ...
        let collateral_account_set_id = Self::find_or_create_account_set(
            cala,
            journal_id,
            format!("{journal_id}:{}", CREDIT_COLLATERAL.external_ref),
            CREDIT_COLLATERAL.name.to_string(),
        ...
        let collateral_in_liquidation_account_set_id = Self::find_or_create_account_set(
            ...
            format!(
                "{journal_id}:{}",
                CREDIT_FACILITY_COLLATERAL_IN_LIQUIDATION.external_ref
            ),
            CREDIT_FACILITY_COLLATERAL_IN_LIQUIDATION.name.to_string(),
        ...
        let liquidated_collateral_account_set_id = Self::find_or_create_account_set(
            ...
            format!(
                "{journal_id}:{}",
                CREDIT_FACILITY_LIQUIDATED_COLLATERAL.external_ref
            ),
            CREDIT_FACILITY_LIQUIDATED_COLLATERAL.name.to_string(),
        ...
        let proceeds_from_liquidation_account_set_id = Self::find_or_create_account_set(
            ...
            format!(
                "{journal_id}:{}",
                CREDIT_FACILITY_PROCEEDS_FROM_LIQUIDATION.external_ref
            ),
            CREDIT_FACILITY_PROCEEDS_FROM_LIQUIDATION.name.to_string(),
        ...
        let short_term_individual_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    SHORT_TERM_INDIVIDUAL_DISBURSED_RECEIVABLE.external_ref
                ),
                SHORT_TERM_INDIVIDUAL_DISBURSED_RECEIVABLE.name.to_string(),
        ...
        let short_term_government_entity_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    SHORT_TERM_GOVERNMENT_ENTITY_DISBURSED_RECEIVABLE.external_ref
                ),
                SHORT_TERM_GOVERNMENT_ENTITY_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let short_term_private_company_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    SHORT_TERM_PRIVATE_COMPANY_DISBURSED_RECEIVABLE.external_ref
                ),
                SHORT_TERM_PRIVATE_COMPANY_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let short_term_bank_disbursed_receivable_account_set_id = Self::find_or_create_account_set(
            ...
            format!(
                "{journal_id}:{}",
                SHORT_TERM_BANK_DISBURSED_RECEIVABLE.external_ref
            ),
            SHORT_TERM_BANK_DISBURSED_RECEIVABLE.name.to_string(),
            disbursed_receivable_normal_balance_type,
        )
        .await?;
        let short_term_financial_institution_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    SHORT_TERM_FINANCIAL_INSTITUTION_DISBURSED_RECEIVABLE.external_ref
                ),
                SHORT_TERM_FINANCIAL_INSTITUTION_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let short_term_foreign_agency_or_subsidiary_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    SHORT_TERM_FOREIGN_AGENCY_OR_SUBSIDIARY_DISBURSED_RECEIVABLE.external_ref
                ),
                SHORT_TERM_FOREIGN_AGENCY_OR_SUBSIDIARY_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let short_term_non_domiciled_company_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    SHORT_TERM_NON_DOMICILED_COMPANY_DISBURSED_RECEIVABLE.external_ref
                ),
                SHORT_TERM_NON_DOMICILED_COMPANY_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let long_term_individual_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    LONG_TERM_INDIVIDUAL_DISBURSED_RECEIVABLE.external_ref
                ),
                LONG_TERM_INDIVIDUAL_DISBURSED_RECEIVABLE.name.to_string(),
                disbursed_receivable_normal_balance_type,
            )
            .await?;
        let long_term_government_entity_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    LONG_TERM_GOVERNMENT_ENTITY_DISBURSED_RECEIVABLE.external_ref
                ),
                LONG_TERM_GOVERNMENT_ENTITY_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let long_term_private_company_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    LONG_TERM_PRIVATE_COMPANY_DISBURSED_RECEIVABLE.external_ref
                ),
                LONG_TERM_PRIVATE_COMPANY_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let long_term_bank_disbursed_receivable_account_set_id = Self::find_or_create_account_set(
            ...
            format!(
                "{journal_id}:{}",
                LONG_TERM_BANK_DISBURSED_RECEIVABLE.external_ref
            ),
            LONG_TERM_BANK_DISBURSED_RECEIVABLE.name.to_string(),
            disbursed_receivable_normal_balance_type,
        )
        .await?;
        let long_term_financial_institution_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    LONG_TERM_FINANCIAL_INSTITUTION_DISBURSED_RECEIVABLE.external_ref
                ),
                LONG_TERM_FINANCIAL_INSTITUTION_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let long_term_foreign_agency_or_subsidiary_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    LONG_TERM_FOREIGN_AGENCY_OR_SUBSIDIARY_DISBURSED_RECEIVABLE.external_ref
                ),
                LONG_TERM_FOREIGN_AGENCY_OR_SUBSIDIARY_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let long_term_non_domiciled_company_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    LONG_TERM_NON_DOMICILED_COMPANY_DISBURSED_RECEIVABLE.external_ref
                ),
                LONG_TERM_NON_DOMICILED_COMPANY_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let overdue_individual_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    OVERDUE_INDIVIDUAL_DISBURSED_RECEIVABLE.external_ref
                ),
                OVERDUE_INDIVIDUAL_DISBURSED_RECEIVABLE.name.to_string(),
                disbursed_receivable_normal_balance_type,
            )
            .await?;
        let overdue_government_entity_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    OVERDUE_GOVERNMENT_ENTITY_DISBURSED_RECEIVABLE.external_ref
                ),
                OVERDUE_GOVERNMENT_ENTITY_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let overdue_private_company_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    OVERDUE_PRIVATE_COMPANY_DISBURSED_RECEIVABLE.external_ref
                ),
                OVERDUE_PRIVATE_COMPANY_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let overdue_bank_disbursed_receivable_account_set_id = Self::find_or_create_account_set(
            ...
            format!(
                "{journal_id}:{}",
                OVERDUE_BANK_DISBURSED_RECEIVABLE.external_ref
            ),
            OVERDUE_BANK_DISBURSED_RECEIVABLE.name.to_string(),
            disbursed_receivable_normal_balance_type,
        )
        .await?;
        let overdue_financial_institution_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    OVERDUE_FINANCIAL_INSTITUTION_DISBURSED_RECEIVABLE.external_ref
                ),
                OVERDUE_FINANCIAL_INSTITUTION_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let overdue_foreign_agency_or_subsidiary_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    OVERDUE_FOREIGN_AGENCY_OR_SUBSIDIARY_DISBURSED_RECEIVABLE.external_ref
                ),
                OVERDUE_FOREIGN_AGENCY_OR_SUBSIDIARY_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let overdue_non_domiciled_company_disbursed_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    OVERDUE_NON_DOMICILED_COMPANY_DISBURSED_RECEIVABLE.external_ref
                ),
                OVERDUE_NON_DOMICILED_COMPANY_DISBURSED_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let disbursed_defaulted_account_set_id = Self::find_or_create_account_set(
            cala,
            journal_id,
            format!("{journal_id}:{}", CREDIT_DISBURSED_DEFAULTED.external_ref),
            CREDIT_DISBURSED_DEFAULTED.name.to_string(),
            disbursed_receivable_normal_balance_type,
        )
        .await?;
        ...
        let short_term_individual_interest_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    SHORT_TERM_INDIVIDUAL_INTEREST_RECEIVABLE.external_ref
                ),
                SHORT_TERM_INDIVIDUAL_INTEREST_RECEIVABLE.name.to_string(),
        ...
        let short_term_government_entity_interest_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    SHORT_TERM_GOVERNMENT_ENTITY_INTEREST_RECEIVABLE.external_ref
                ),
                SHORT_TERM_GOVERNMENT_ENTITY_INTEREST_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let short_term_private_company_interest_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    SHORT_TERM_PRIVATE_COMPANY_INTEREST_RECEIVABLE.external_ref
                ),
                SHORT_TERM_PRIVATE_COMPANY_INTEREST_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let short_term_bank_interest_receivable_account_set_id = Self::find_or_create_account_set(
            ...
            format!(
                "{journal_id}:{}",
                SHORT_TERM_BANK_INTEREST_RECEIVABLE.external_ref
            ),
            SHORT_TERM_BANK_INTEREST_RECEIVABLE.name.to_string(),
            interest_receivable_normal_balance_type,
        )
        .await?;
        ...
        let short_term_financial_institution_interest_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    SHORT_TERM_FINANCIAL_INSTITUTION_INTEREST_RECEIVABLE.external_ref
                ),
                SHORT_TERM_FINANCIAL_INSTITUTION_INTEREST_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let short_term_foreign_agency_or_subsidiary_interest_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    SHORT_TERM_FOREIGN_AGENCY_OR_SUBSIDIARY_INTEREST_RECEIVABLE.external_ref
                ),
                SHORT_TERM_FOREIGN_AGENCY_OR_SUBSIDIARY_INTEREST_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let short_term_non_domiciled_company_interest_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    SHORT_TERM_NON_DOMICILED_COMPANY_INTEREST_RECEIVABLE.external_ref
                ),
                SHORT_TERM_NON_DOMICILED_COMPANY_INTEREST_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let long_term_individual_interest_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    LONG_TERM_INDIVIDUAL_INTEREST_RECEIVABLE.external_ref
                ),
                LONG_TERM_INDIVIDUAL_INTEREST_RECEIVABLE.name.to_string(),
                interest_receivable_normal_balance_type,
            )
            .await?;
        ...
        let long_term_government_entity_interest_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    LONG_TERM_GOVERNMENT_ENTITY_INTEREST_RECEIVABLE.external_ref
                ),
                LONG_TERM_GOVERNMENT_ENTITY_INTEREST_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let long_term_private_company_interest_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    LONG_TERM_PRIVATE_COMPANY_INTEREST_RECEIVABLE.external_ref
                ),
                LONG_TERM_PRIVATE_COMPANY_INTEREST_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let long_term_bank_interest_receivable_account_set_id = Self::find_or_create_account_set(
            ...
            format!(
                "{journal_id}:{}",
                LONG_TERM_BANK_INTEREST_RECEIVABLE.external_ref
            ),
            LONG_TERM_BANK_INTEREST_RECEIVABLE.name.to_string(),
            interest_receivable_normal_balance_type,
        )
        .await?;
        ...
        let long_term_financial_institution_interest_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    LONG_TERM_FINANCIAL_INSTITUTION_INTEREST_RECEIVABLE.external_ref
                ),
                LONG_TERM_FINANCIAL_INSTITUTION_INTEREST_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let long_term_foreign_agency_or_subsidiary_interest_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    LONG_TERM_FOREIGN_AGENCY_OR_SUBSIDIARY_INTEREST_RECEIVABLE.external_ref
                ),
                LONG_TERM_FOREIGN_AGENCY_OR_SUBSIDIARY_INTEREST_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let long_term_non_domiciled_company_interest_receivable_account_set_id =
            Self::find_or_create_account_set(
                ...
                format!(
                    "{journal_id}:{}",
                    LONG_TERM_NON_DOMICILED_COMPANY_INTEREST_RECEIVABLE.external_ref
                ),
                LONG_TERM_NON_DOMICILED_COMPANY_INTEREST_RECEIVABLE
                    .name
                    .to_string(),
        ...
        let interest_defaulted_account_set_id = Self::find_or_create_account_set(
            cala,
            journal_id,
            format!("{journal_id}:{}", CREDIT_INTEREST_DEFAULTED.external_ref),
            CREDIT_INTEREST_DEFAULTED.name.to_string(),
            interest_receivable_normal_balance_type,
        )
        .await?;
        ...
        let interest_income_account_set_id = Self::find_or_create_account_set(
            cala,
            journal_id,
            format!("{journal_id}:{}", CREDIT_INTEREST_INCOME.external_ref),
            CREDIT_INTEREST_INCOME.name.to_string(),
        ...
        let fee_income_account_set_id = Self::find_or_create_account_set(
            cala,
            journal_id,
            format!("{journal_id}:{}", CREDIT_FEE_INCOME.external_ref),
            CREDIT_FEE_INCOME.name.to_string(),
        ...
        let uncovered_outstanding_account_set_id = Self::find_or_create_account_set(
            cala,
            journal_id,
            format!("{journal_id}:{}", CREDIT_UNCOVERED_OUTSTANDING.external_ref),
            CREDIT_UNCOVERED_OUTSTANDING.name.to_string(),
        ...
        let payment_holding_account_set_id = Self::find_or_create_account_set(
            cala,
            journal_id,
            format!("{journal_id}:{}", CREDIT_PAYMENT_HOLDING.external_ref),
            CREDIT_PAYMENT_HOLDING.name.to_string(),
